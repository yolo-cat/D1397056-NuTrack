...
struct SimpleLoginView: View {
    ...
    private var logoSection: some View { /* ... Omitted for brevity ... */ }
    private var loginFormSection: some View { /* ... Omitted for brevity ... */ }
    private var quickSelectSection: some View { /* ... Omitted for brevity ... */ }
